...
class NotificationManager:
    ...
    def show_quick_notification(
        self, title: str, message: str, duration: float = 1.5
    ) -> None:
        """
        ...
        def _show_quick():
            try:
                ...
                canvas = tk.Canvas(
                    top, width=width, height=height, bg="black", highlightthickness=0
                )
                ...
                round_rect(
                    2, 2, width - 2, height - 2, r=14, fill="#2b2b2b", outline="#3c3c3c"
                )
                ...
                lbl_title = tk.Label(
                    frame, text=title, fg="#c5e1ff", bg="#2b2b2b", font=title_font
                )
