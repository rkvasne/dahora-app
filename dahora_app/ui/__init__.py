...
from dahora_app.ui.modern_styles import (
    ...
    ModernTabview, ModernScrollableFrame, ModernTextbox
)
...
__all__ = [
    ...
    'SearchDialog', 'CustomShortcutsDialog', 'ShortcutEditorDialog', 'AboutDialog',
    # Modern UI
    'ModernTheme', 'ModernWindow', 'ModernFrame', 'ModernButton',
    'ModernEntry', 'ModernLabel', 'ModernCheckbox', 'ModernSpinbox',
    'ModernTabview', 'ModernScrollableFrame', 'ModernTextbox',
    'ModernSettingsDialog', 'ModernShortcutEditor',
    'ModernAboutDialog', 'ModernSearchDialog'
]
