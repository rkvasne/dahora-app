...
class ModernSpinbox(ctk.CTkFrame):
    ...
    def __init__(self, parent, from_: int = 0, to: int = 100, 
                 variable=None, width: int = 100, **kwargs):
        colors = ModernTheme.get_colors()
        ...
        self.btn_up = ctk.CTkButton(btn_frame, text="▲", width=24, height=17,
        ...
        self.btn_down = ctk.CTkButton(btn_frame, text="▼", width=24, height=17,
                                     corner_radius=4, fg_color=colors['bg_tertiary'],
                                     hover_color=colors['surface'],
                                     text_color=colors['text'],
...
class ModernScrollableFrame(ctk.CTkScrollableFrame):
    ...
    def __init__(self, parent, **kwargs):
        ...
        self._sb_visible_color = defaults.get('scrollbar_button_color', colors['bg_tertiary'])
        self._sb_visible_hover_color = defaults.get('scrollbar_button_hover_color', colors['surface'])
    ...
    def _update_scrollbar_visibility(self, event=None) -> None:
        try:
            ...
            try:
                if scrollbar.winfo_manager() == "grid" and not scrollbar.winfo_ismapped():
                    scrollbar.grid()
            except Exception:
                pass
