...
class Windows11Style:
    ...
    def configure_window(
        window: Window, title: str = "Dahora App", size: str = "700x450"
    ):
    ...
    def configure_styles(window: Window):
        ...
        style.map(
            "Success.TButton",
            background=[
                ("active", "#45a049"),  # Verde mais escuro no hover
        ...
        style.map(
            "Danger.TButton",
            background=[
                ("active", "#d32f2f"),  # Vermelho mais escuro no hover
        ...
        style.map(
            "TNotebook.Tab",
            background=[
                ("selected", Windows11Style.COLORS["bg"]),
                ("active", Windows11Style.COLORS["bg"]),
                ("!active", Windows11Style.COLORS["bg"]),
            ],
            foreground=[
                ("selected", Windows11Style.COLORS["accent"]),
                ("active", Windows11Style.COLORS["text"]),
        ...
        # === SEPARATOR MODERNO ===
        style.configure("TSeparator", background=Windows11Style.COLORS["border"])
