...
print(f"Is key valid: {HotkeyValidator._is_valid_key(key) if key is not None else False}")
...
print(f"3. Key validity: {HotkeyValidator._is_valid_key(key) if key is not None else False}")
