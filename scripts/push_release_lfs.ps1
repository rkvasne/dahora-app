...
.DESCRIPTION
#  Executa o checklist do docs/release-process.md:
  - git lfs install
...
.EXAMPLE
  powershell -ExecutionPolicy Bypass -File scripts\push_release_lfs.ps1 -Message "v0.2.7: Binários para LFS"
#>
...
Write-Host "== git add =="
& git add .gitattributes .gitignore build.py README.md docs/release-process.md scripts/README.md scripts/prepare_release_artifacts.ps1 scripts/prepare_release_artifacts.bat scripts/push_release_lfs.ps1
